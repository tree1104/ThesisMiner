...
class TestValidateEnum:
    ...
    def test_valid_value(self):
        """测试有效枚举值。"""
        result = validate_enum("master", ["master", "doctor"], field="degree")
        assert result.is_valid is True

    def test_invalid_value(self):
        """测试无效枚举值。"""
        result = validate_enum("invalid", ["master", "doctor"], field="degree")
        assert result.is_valid is False

    def test_empty_value(self):
        """测试空值。"""
        result = validate_enum("", ["master", "doctor"], field="degree")
        assert result.is_valid is False

    def test_none_value(self):
        """测试 None 值。"""
        result = validate_enum(None, ["master", "doctor"], field="degree")
        assert result.is_valid is False
