...
│   sessions / budgets   （7 个路由模块，37 个端点）                │
└───────────────────────────┬─────────────────────────────────────┘
                            │ 函数调用
┌───────────────────────────┴─────────────────────────────────────┐
│                    业务服务层（多智能体协作）                      │
...
遵循 RESTful 风格，统一前缀 `/api`，返回 JSON。系统共提供 **37 个** API 端点，分布于 7 个路由模块。
...
> 文档版本 V4.0（增强版）· 最后更新 2026-06-19 · 对应应用版本 ThesisMiner v6.0
